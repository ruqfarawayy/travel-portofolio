        ...
        <div class="row">
                ...
                <table class="table table-responsive-sm text-center">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img
                          src="<?php echo e(url('/frontend/images/avatar-4.png')); ?>"
                          alt=""
                          height="60"
                        />
                      </td>
                    ...
                    <tr>
                      <td>
                        <img
                          src="<?php echo e(url('/frontend/images/avatar-5.png')); ?>"
                          alt=""
                          height="60"
                        />
                      </td>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="bank">
                <div class="bank-item pb-3">
                  <img
                    src="<?php echo e(url('/frontend/images/ic_bank.png')); ?>"
                    alt=""
                    class="bank-image"
                  />
            ...
            <div class="join-container">
              <a
                href="<?php echo e(route('checkout-success')); ?>"
                class="btn btn-block btn-join-now mt-3 py-2"
                >I Have Made Payment</a
              >
            </div>
            <div class="text-center mt-3">
              <a href="<?php echo e(route('detail')); ?>" class="text-muted">Cancel Booking</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      $(document).ready(function() {
        $('.datepicker').datepicker({
          ...
          icons: {
            rightIcon: '<img src="<?php echo e(url('/frontend/images/ic_doe.png')); ?>" alt="" />'
          }
        });
      });
    </script>
...
<?php echo $__env->make('layouts.checkout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Documents\01 - sirel\nomads\resources\views/pages/checkout.blade.php ENDPATH**/ ?>